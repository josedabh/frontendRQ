...
- [ ] Prioridad alta: Arquitectura y configuración API
- [ ] Prioridad alta: Seguridad y manejo de errores
- [ ] Prioridad media: Navegación y tipado
- [ ] Prioridad media: Rendimiento inicial
- [ ] Prioridad baja: Limpieza/estilo de código
