...
export default function AddRewardScreen() {
    ...
    // Si viene editId, iniciamos en modo edición
    ...
    return (
        <SafeAreaView style={{ padding: 16, flex: 1 }}>
            ...
            <TextInput
                ...
                onChangeText={(t) =>
                    setFormData({ ...formData, points: Number(t) || 0 })
                }
            ...
            <TextInput
                ...
                onChangeText={(t) =>
                    setFormData({ ...formData, stock: Number(t) || 0 })
                }
                keyboardType="numeric"
                placeholder="0"
            />
            ...
            <View style={styles.switchContainer}>
                ...
                <Text
                    style={[
                        styles.status,
                        { color: formData.active ? 'green' : 'gray' },
                    ]}
                >
...
const styles = StyleSheet.create({
    ...
    status: { marginLeft: 8, fontSize: 16 },
    buttonContainer: {
        flexDirection: 'row',
