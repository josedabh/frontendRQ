...
export default function ManageProductsScreen() {
  const [products, setProducts] = useState<Product[]>([
    { id: 1, name: 'Reward 1', description: 'Reward 1 description', points: 100, active: true, stock: 5 },
    { id: 2, name: 'Reward 2', description: 'Reward 2 description', points: 200, active: false, stock: 0 },
  ...
  const renderItem = ({ item }: { item: Product }) => (
    <View style={styles.card}>
      <View style={styles.info}>
        ...
        <Text style={styles.small}>Puntos: {item.points} · Stock: {item.stock}</Text>
      ...
      <View style={styles.actions}>
        ...
        <TouchableOpacity onPress={() => onToggleActive(item)} style={styles.actionBtn}>
